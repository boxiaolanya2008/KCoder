...
Use this folder for locale-specific translation guidance that supplements `.KCoder/agent/translator.md`.
...
- PR #12345: https://github.com/yourname/kcoder/pull/12345

## Do Not Translate (Locale Additions)

- `KCoder` (preserve casing)
