...
- PR #9821: https://github.com/yourname/kcoder/pull/9821
- PR #13160: https://github.com/yourname/kcoder/pull/13160

## Do Not Translate (Locale Additions)

- `KCoder` (preserve casing in prose; keep `KCoder` only in commands, package names, paths, or code)
- `KCoder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
| WSL integration description | `WindowsのWSL環境�?..` | PR #13160 improved phrasing naturally |
