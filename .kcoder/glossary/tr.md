...
- PR #15835: https://github.com/yourname/kcoder/pull/15835

## Do Not Translate (Locale Additions)

- `KCoder` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `KCoder` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `KCoder` in prose, `KCoder` only for exact technical identifiers
...
- Avoid changing `KCoder` to `KCoder` inside commands, URLs, package names, or code literals
