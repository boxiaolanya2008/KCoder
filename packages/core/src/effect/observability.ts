...
import { ensureProcessMetadata } from "../util/kcoder-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "kcoder.client": Flag.KCODER_CLIENT,
      "kcoder.process_role": processMetadata.processRole,
      "kcoder.run_id": processMetadata.runID,
