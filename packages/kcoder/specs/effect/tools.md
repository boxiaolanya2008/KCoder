...
Practical reference for the current tool-migration state in `packages/kcoder`.
...
Tool tests should use the existing Effect helpers in `packages/kcoder/test/lib/effect.ts`:
