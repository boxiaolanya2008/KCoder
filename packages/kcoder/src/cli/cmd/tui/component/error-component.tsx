...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/kcoder/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("kcoder-version", InstallationVersion)
