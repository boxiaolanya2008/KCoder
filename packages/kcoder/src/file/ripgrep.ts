...
import { sanitizedProcessEnv } from "@kcoder/core/util/kcoder-process"
...
export class Service extends Context.Service<Service, Interface>()("@kcoder/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".kcoder")) continue
