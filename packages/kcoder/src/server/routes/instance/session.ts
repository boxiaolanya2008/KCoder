  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all KCoder sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific KCoder session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new KCoder session for interacting with AI assistants and managing conversations.",
