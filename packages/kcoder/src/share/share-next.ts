import type * as SDK from "@kcoder/sdk/v2"
...
const disabled = process.env["KCODER_DISABLE_SHARE"] === "true" || process.env["KCODER_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@kcoder/ShareNext") {}
