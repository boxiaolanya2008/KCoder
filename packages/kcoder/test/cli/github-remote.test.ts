...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kcoder.git")).toEqual({ owner: "sst", repo: "kcoder" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kcoder")).toEqual({ owner: "sst", repo: "kcoder" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kcoder.git")).toEqual({ owner: "sst", repo: "kcoder" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kcoder")).toEqual({ owner: "sst", repo: "kcoder" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kcoder.git")).toEqual({ owner: "sst", repo: "kcoder" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kcoder")).toEqual({ owner: "sst", repo: "kcoder" })
})
