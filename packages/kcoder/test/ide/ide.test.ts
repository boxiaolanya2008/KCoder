...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KCODER_CALLER", () => {
    process.env["KCODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KCODER_CALLER", () => {
    process.env["KCODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KCODER_CALLER", () => {
    process.env["KCODER_CALLER"] = "unknown"
