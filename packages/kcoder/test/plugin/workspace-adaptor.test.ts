...
const { Flag } = await import("@kcoder/core/flag/flag")
const { Plugin } = await import("../../src/plugin/index")
const { Workspace } = await import("../../src/control-plane/workspace")
const { Instance } = await import("../../src/project/instance")

const experimental = Flag.KCODER_EXPERIMENTAL_WORKSPACES

Flag.KCODER_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.KCODER_EXPERIMENTAL_WORKSPACES = experimental
})
