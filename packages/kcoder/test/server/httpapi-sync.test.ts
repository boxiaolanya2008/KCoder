...
const originalHttpApi = Flag.KCODER_EXPERIMENTAL_HTTPAPI
const originalWorkspaces = Flag.KCODER_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  Flag.KCODER_EXPERIMENTAL_HTTPAPI = originalHttpApi
  Flag.KCODER_EXPERIMENTAL_WORKSPACES = originalWorkspaces
