...
/**
 * Server configuration for kcoder serve commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: kcoder.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://kcoder.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://kcoder.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
