...
Generates UPCOMING_CHANGELOG.md by running the kcoder changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for kcoder run (default: low)
      --quiet            Suppress kcoder command output unless it fails
