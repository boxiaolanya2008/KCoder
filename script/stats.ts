...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/yourname/kcoder/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for yourname/kcoder...\n")
...
console.log("Fetching npm all-time downloads for kcoder...\n")
const npmDownloads = await fetchNpmDownloads("kcoder")
